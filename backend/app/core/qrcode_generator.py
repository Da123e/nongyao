...
def generate_trace_qrcode(batch_id: str, seed_batch_id: str, url_prefix: str = "http://localhost:8000") -> str:
    qr_data = {
        'batch_id': batch_id,
        'seed_batch_id': seed_batch_id,
        'trace_url': f"{url_prefix}/api/blockchain/trace/{seed_batch_id}"
    }
